            ...
            try {
                if (v is List<*> && dimensions != null) {
                    ...
                    v = when (dataTypeIdentifier) {
                        ...
                        NodeIds.Byte -> deepCast<UByte>(dimensions, v) { asType(it, NodeIds.Byte) as UByte }
                        NodeIds.UInt16 -> deepCast<UShort>(dimensions, v) { asType(it, NodeIds.Int32) as UShort }
                        ...
                        NodeIds.NodeId -> deepCast<NodeId>(dimensions, v) { asType(it, NodeIds.NodeId) as NodeId }
